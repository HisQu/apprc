...
- **Suggested next step:** Choose one cross-process lock and conflict policy for all managed writes before shipping the Toga GUI. Add CLI/GUI concurrent-writer tests on Linux and Windows.
