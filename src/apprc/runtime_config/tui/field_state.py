...
# == Internal ================================
from apprc.runtime_config.storage.local_env import normalize_env_value
...
def config_value_sources(
    *,
    ...
    return (
        ...
        EditableConfigValueSource(key="local", raw_value=local_value),
        EditableConfigValueSource(
            key="shared",
