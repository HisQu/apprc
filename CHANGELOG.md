...
3. [0.23.1 - 2026-09-08](#0231---2026-09-08)
4. [0.23.0 - 2026-09-08](#0230---2026-09-08)
...
### 🔨 Fixed
  ...
  - Fixed release validation tests that depended on the local terminal width
    when checking rendered migration options and recovery guidance.
