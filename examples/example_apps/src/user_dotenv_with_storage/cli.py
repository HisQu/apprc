"""Combined-capability AppRC example CLI."""
...
def build_app(
    *,
    ...
    """Return the combined-capability example CLI.
    ...
    """
    app = typer.Typer(
        help="Exercise AppRC with a user dotenv and named storage.",
...
def _runtime_payload(
    ...
    config = state.resolved.build(UserDotenvWithStorageExampleConfig).app
...
def main() -> None:
    """Run the combined-capability example CLI."""
    app()
