"""Process-environment-only AppRC example CLI."""
...
import apprc as rc
from process_env.config import MyRC, ProcessEnvExampleConfig
...
def build_app(
    *,
    ...
    """Return the process-environment example CLI.
    ...
    """
    app = typer.Typer(
        help="Exercise AppRC without managed user files.",
...
def _runtime_payload(
    ...
    config = ProcessEnvExampleConfig().app
    return {
...
def main() -> None:
    """Run the process-environment example CLI."""
    app()
